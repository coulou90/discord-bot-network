...
ROOT — Tu préfères travailler avec ?
├── 1️⃣ Cisco
│   ├── Q2 : Configuration ou Dépannage ?
│   │   ├── 1️⃣ Config réseau → Q3 Cisco Config
│   │   │   ├── 1️⃣ LAN/VLAN → 🎯 Admin LAN/VLAN
│   │   │   └── 2️⃣ Sécurité → 🔥 Admin Sécurité Réseau
│   │   └── 2️⃣ Dépannage → Q3 Cisco Dépannage
│   │       ├── 1️⃣ Analyse → 🔍 Support N2
│   │       └── 2️⃣ Intervention → ⚡ Ingénieur NOC
│
└── 2️⃣ Linux
    ├── Q2 : Administration ou Automatisation ?
    │   ├── 1️⃣ Services réseau → Q3 Linux Services
    │   │   ├── 1️⃣ Serveurs → 🧰 Admin Sys Linux
    │   │   └── 2️⃣ Virtualisation → 🖥️ Ingénieur Virtualisation
    │   └── 2️⃣ Automatisation → Q3 Linux Auto
    │       ├── 1️⃣ Déploiements → 🤖 DevOps
    │       └── 2️⃣ Monitoring → 📈 Ingénieur Monitoring
